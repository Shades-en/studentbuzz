        ...
        <>
            <div className="lg:flex">
                <div className="mt-7 lg:w-1/2 xl:max-w-screen-sm">
                    <div className="py-12 bg-indigo-500 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    </div>
                    <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">

                        {type.faculty &&  <h3 className="text-left text-4xl  font-display font-bold lg:text-left xl:text-4xl
                        ...
                        <div className="mt-12">
                            ...
                            {type.faculty && <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                Are you a University ? <Link to="/login-uni" className="cursor-pointer text-indigo-600 hover:text-indigo-500">University Login</Link>
                            </div>}

                            {type.uni && <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                Are you a Faculty ? <Link to="/login-faculty" className="cursor-pointer text-indigo-600 hover:text-indigo-500">Faculty Login</Link>
                            </div>}
                        </div>
                    </div>
                </div>
                <div className="hidden lg:flex items-center justify-center bg-indigo-300 flex-1 h-screen">
