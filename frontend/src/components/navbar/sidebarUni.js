...
const SidebarUni= () => {
    ...
    function changeActive() {
        ...
        if(url.includes('feed')) {
            nav = {feed: true, search: false}
        }
        if(url.includes('search')) {
            nav = {feed: false,  search: true}
        }
        var current
            ...
            <div className="min-h-screen w-52 z-10 flex flex-row bg-gray-100 fixed left-0 shadow-2xl" id="nav_container">
                <div className="flex flex-col mt-5 w-full">
                    ...
                    <li >
                        ...
                        <span className="text-sm font-medium hover:#6366f1 flex items-center justify-start"> <FeedOutlinedIcon fontSize="small" className="text-indigo-500 mr-3"/> <Link to="/uni/feed" onClick={handleActive} id="feed" >Feed</Link>
                        </span>
                        </a>
                    </li>
                    <li >
                        ...
                        <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"></span>
                        <span className="text-sm font-medium hover:#6366f1 flex items-center justify-start"> <PersonSearchOutlinedIcon fontSize="small" className="text-indigo-500 mr-3"/> <Link to="/uni/search" onClick={handleActive} id="search"> Search </Link> </span>
                        </a>
                    </li>
                    </ul>
                </div>
