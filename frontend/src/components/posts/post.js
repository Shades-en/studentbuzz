    ...
    return (  
        <div className="flex h-fit w-3/4" >
            <div className="my-3 pt-2 container bg-white rounded-sm shadow-lg transform transition duration-500 hover:shadow-2xl h-fit">
                <div>
                    <h1 className="text-xl mt-2 ml-4 font-bold text-gray-800 cursor-pointer hover:text-gray-900 transition duration-100">Entrepreneurship Development Cell</h1>
                    <p className="ml-4 mt-1 mb-2 text-sm text-gray-700 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                </div>
                ...
                <div className="flex p-4 pt-1  justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <div>
                            <h2 className="text-gray-800 font-bold cursor-pointer">Umraz Khan</h2>
                            <h6 className="text-gray-400 text-xs "> 12th January, 2020</h6>
                        </div>
                    </div>
                </div>
            </div>
