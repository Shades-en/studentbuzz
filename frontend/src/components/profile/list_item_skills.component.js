...
const ListItemSkills = () => {
    return ( 
        <>
        <div className='flex'>
        <div className="flex justify-start items-center cursor-pointer w-[27em] shadow-md text-gray-700 hover:text-blue-400 hover:bg-blue-100 rounded-md px-2 py-2 my-2">
            <div>
