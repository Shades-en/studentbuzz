    ...
    return (  
        <>  
            <div className="flex justify-center items-start">
                <div className="flex items-center p-3 w-auto bg-white rounded-lg shadow-xl  max-w-sm relative my-2 mx-3" style={{"boxShadow": "0 0 10px 1px rgba(130, 130, 130, 0.2)"}}>
                    ...
                    <div className="ml-5">
                        <h4 className="text-sm font-semibold leading-tight text-gray-900">Reva Hack Runner up</h4>
