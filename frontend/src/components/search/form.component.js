        ...
        <>
            <div class="flex p-6 student_form_container">
                <div class="mx-auto"> 
                    ...
                    <div className="mb-3">
                            <label for="name" className="mb-2 block text-base font-medium text-[#6366f1]" >University</label>
                        ...
                        <div className="mb-3">
                            <label for="name" className="mb-2 block text-base font-medium text-[#6366f1]" >Branch</label>
                        ...
                        <div className="mb-3">
                            <label for="name" className="mb-2 block text-base font-medium text-[#6366f1]" >USN</label>
                        ...
                        <div className="mb-3">
                            <label for="name" className="mb-2 block text-base font-medium text-[#6366f1]" >Tech Stack</label>
